...
import Score from "../../components/video_learn_page/Score";
import VideoPose from "../../components/video_learn_page/VideoPose";
import WebcamPose from "../../components/video_learn_page/WebcamPose";
